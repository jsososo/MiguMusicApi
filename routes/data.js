...
module.exports = {
  ...
  ['/addWhiteList']({ req, res }) {
    listHandle({ func: 'addList', req, res, type: 'whiteList'});
  },
  ['/addBlackList']({ req, res }) {
    listHandle({ func: 'addList', req, res, type: 'blackList'});
  },
  ['/removeWhiteList']({ req, res }) {
    listHandle({ func: 'removeList', req, res, type: 'whiteList'});
  },
  ['/removeBlackList']({ req, res }) {
    listHandle({ func: 'removeList', req, res, type: 'blackList'});
  },
  ['/whiteList']({ res }) {
    res.send({
      result: 100,
